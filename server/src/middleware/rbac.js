...
const PERMISSION_MAP = {
  ...
  QLloaiphim:  [ROLES.SYSTEM_ADMIN, ROLES.CLUSTER_MANAGER, ROLES.CINEMA_MANAGER],
  themloai:    [ROLES.SYSTEM_ADMIN, ROLES.CLUSTER_MANAGER, ROLES.CINEMA_MANAGER],
  sualoai:     [ROLES.SYSTEM_ADMIN, ROLES.CLUSTER_MANAGER, ROLES.CINEMA_MANAGER],
  xoaloai:     [ROLES.SYSTEM_ADMIN, ROLES.CLUSTER_MANAGER, ROLES.CINEMA_MANAGER],
